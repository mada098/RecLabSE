        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentID = table.Column<Guid>(nullable: false),
                    ClassroomID = table.Column<Guid>(nullable: false),
                    StudentID1 = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stoc", x => x.StudentID);
                    table.ForeignKey(
                        name: "FK_Stoc_Classrooms_ClassroomID",
                        column: x => x.ClassroomID,
                        principalTable: "Classrooms",
                        principalColumn: "ClassroomID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stoc_Students_StudentID1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classrooms_ProfessorID",
                table: "Classrooms",
                column: "ProfessorID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stoc_ClassroomID",
                table: "Stoc",
                column: "ClassroomID");

            migrationBuilder.CreateIndex(
                name: "IX_Stoc_StudentID1",
                table: "Stoc",
                column: "StudentID1");
        }
